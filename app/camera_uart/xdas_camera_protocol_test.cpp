...
int main()
{
    ...
    std::printf("XDAS_PROTOCOL_TEST_OK crc=CRC8_D5 reference=version,mode,capacity,get_time,set_time,uvc save=global,targeted,idempotent,sticky_error,rollback pty=fragmented,repeated,crc_recovery,resync\n");
    return 0;
}
