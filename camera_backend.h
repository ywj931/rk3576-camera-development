...
/* Fills the RV1126B/dual-IMX586 defaults used by camera_aiq_test. */
...
int camera_backend_set_exposure(camera_backend_t *backend, int camera_id,
                                uint32_t exposure_us);
/* Sets/queries the automatic AE ceiling without changing manual exposure. */
int camera_backend_set_max_exposure(camera_backend_t *backend, int camera_id,
                                    uint32_t max_exposure_us);
int camera_backend_get_max_exposure(camera_backend_t *backend, int camera_id,
                                    uint32_t *max_exposure_us);
